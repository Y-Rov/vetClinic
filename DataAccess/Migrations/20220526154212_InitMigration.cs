        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Street = table.Column<string>(type: "nvarchar(85)", maxLength: 85, nullable: false),
                    House = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ApartmentNumber = table.Column<short>(type: "smallint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcedureSpecializations", x => new { x.ProcedureId, x.SpecializationId });
                    table.ForeignKey(
                        name: "FK_ProcedureSpecializations_Procedures_ProcedureId",
                        column: x => x.ProcedureId,
                        principalTable: "Procedures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProcedureSpecializations_Specializations_SpecializationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetHasOccureding = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentProcedures", x => new { x.ProcedureId, x.AppointmentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentUsers", x => new { x.UserId, x.AppointmentId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "3e091edc-cdbc-43a4-a78f-4e5fcdbb02f3", "Admin", "ADMIN" },
                    { 2, "f0f3428e-e163-417b-9334-065390483c2f", "Doctor", "DOCTOR" },
                    { 3, "61bc6865-ed83-4dd4-8785-bce832309d31", "Accountant", "ACCOUNTANT" },
                    { 4, "24aa01ea-982c-4d54-abed-30061b90ccf1", "Client", "CLIENT" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "2043fb25-307c-4086-b6ff-14a83899bc1d", null, false, "AdminFirstName", true, null, false, null, null, "ADMIN", "AQAAAAEAACcQAAAAEC4g9Qc3DmFwUdsQiZ8HmTShHZYpWYCLKmXOqx2mtMPibWDhrt3YB16kHZU2pICt9g==", null, false, "5ff178e8-7fac-4198-baec-6dcb22879ffd", false, "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcedureSpecializations_SpecializationId",
                table: "ProcedureSpecializations",
